...
const ActivityCreationForm: React.FC = () => {
    ...
    const formik = useFormik({
        ...
        onSubmit: values => {
            const createActivityPromise = actions.createActivity(
            ...
            toast.promise(createActivityPromise, {
                loading: "Zapisuję aktywność...",
                success: "Aktywność zapisana!",
                error: "Błąd podczas zapisywania aktywności",
            }).then(() => {
                setActivities([...activities , values.name]);});
        },
    ...
    useEffect(() => {
        actions.getInstructorData().then((data) => {
            ...
            setActivities(data.activityNames);
