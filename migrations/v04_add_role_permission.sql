...
insert into permission(name) values ('Notification creation');
...
insert into role_permission(role_id, permission_id,should_be_displayed) values (1,10,false);
...
insert into role_permission(role_id, permission_id,should_be_displayed) values (2,9,false);
insert into role_permission(role_id, permission_id,should_be_displayed) values (2,10,true);
...
insert into role_permission(role_id, permission_id,should_be_displayed) values (3,9,true);
insert into role_permission(role_id, permission_id,should_be_displayed) values (3,10,false);
...
insert into role_permission(role_id, permission_id,should_be_displayed) values (4,9,true);
insert into role_permission(role_id, permission_id,should_be_displayed) values (4,10,false);
