...
insert into login_user(username,password,firstname,lastname,role_id) values ('mod','$2a$10$XwMIl8yC/TxaD4Xzpmla.OntZ3cnYIeW7OGSxFjCI3NVS3BY7KsWO','mod','mod',3);
insert into login_user(username,password,firstname,lastname,role_id) values ('admin','$2a$10$5NEvaF7euFDlEwoVEWqD.eoNk356nt2DzxbYGrRrththXAZzv8rqi','admin','admin',4);
